...
int MainGameWindow(HINSTANCE hInstance, int nCmdShow);
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    result = MainGameWindow(hInstance, nCmdShow);
    ...
    //HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_REBARBIE));
...
int MainGameWindow(HINSTANCE hInstance, int nCmdShow)
{
    ...
    wc.style = 0x100b;
    wc.lpfnWndProc = WndProc; // FUN_00474600;
    wc.cbWndExtra = 0;
    ...
    HWND hWnd = CreateWindowEx(0, wc.lpszClassName, L"Detective Barbie(R) II", 0xcf000,
        0, 0, 0x280, 0x1e0, NULL, NULL, hInstance, NULL); // talvez o param_1 seja hInstance
