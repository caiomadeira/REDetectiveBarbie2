// REConstructBarbieDetective.cpp : Define o ponto de entrada para o aplicativo.
//

#include "framework.h"
#include "REConstructBarbieDetective.h"
#include <stdio.h>
#include <stdlib.h>
                     ...
                     _In_ int       nCmdShow)
{
    ...
    //LoadStringW(hInstance, IDC_RECONSTRUCTBARBIEDETECTIVE, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_RECONSTRUCTBARBIEDETECTIVE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_RECONSTRUCTBARBIEDETECTIVE));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_RECONSTRUCTBARBIEDETECTIVE);
